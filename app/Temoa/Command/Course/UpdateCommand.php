...
class UpdateCommand {
     ...
     */
    public function __construct($id, $internal_number, $external_number, $name, $category, $partner_id, $description, $duration, $format, $visible, $cancelled, $image, $start_at, $tags, $agenda)
    {
        $this->id = $id;
